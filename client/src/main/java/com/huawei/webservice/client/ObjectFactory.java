...
package com.huawei.webservice.client;
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://ser.example.com", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://ser.example.com", "queryWeather");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ser.example.com", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ser.example.com", name = "queryWeather")
