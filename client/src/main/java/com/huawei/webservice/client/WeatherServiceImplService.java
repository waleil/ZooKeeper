 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://ser.example.com", wsdlLocation = "http://localhost:8080/services/weatherService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://ser.example.com", "WeatherServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/services/weatherService?wsdl");
    ...
    public WeatherService getWeatherServiceImplPort() {
        return super.getPort(new QName("http://ser.example.com", "WeatherServiceImplPort"), WeatherService.class);
    }
    ...
    public WeatherService getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ser.example.com", "WeatherServiceImplPort"), WeatherService.class, features);
    }
